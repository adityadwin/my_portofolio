        ...
        <Card maxW={{ base: "90%", md: "70%", lg: "70%" }} boxShadow="none">
          ...
          <CardBody boxShadow="lg">
            ...
            <Text fontSize={{ base: "sm", lg: "lg" }} mt="30px">
              Tugas akhir semester kami adalah membuat sebuah website e-commerce
              menggunakan platform WordPress. Tim kami terdiri dari 3 orang yang
              bekerja sama untuk merancang dan mengembangkan situs ini. Melalui
              proyek ini, kami bertujuan untuk menciptakan sebuah platform yang
              memungkinkan pengguna untuk membeli dan menjual produk secara
